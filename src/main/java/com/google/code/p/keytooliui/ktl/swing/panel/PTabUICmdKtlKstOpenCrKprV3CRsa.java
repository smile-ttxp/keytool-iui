...
public final class PTabUICmdKtlKstOpenCrKprV3CRsa extends PTabUICmdKtlKstOpenCrKprV3CAbs
{
    // ---------------------------
    // private static final String

    public static final String STR_TITLETASK = "Create RSA private key entry, with vers. #3 cert";
    ...
    public PTabUICmdKtlKstOpenCrKprV3CRsa(Frame frmOwner)
    {
        super(
