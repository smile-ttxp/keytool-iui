...
final public class TMEntryCrtShowAll extends TMEntryCrtAbs
{
    // -------------------
    // FINAL STATIC PUBLIC
    ...
    final static public String[] f_s_strsColumnNames = new String[TMEntryCrtShowAll.f_s_intsColW.length];
