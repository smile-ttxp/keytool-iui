...
abstract public class KTLKprSaveFromJksToAbs extends KTLKprSaveFromAbs
{
    // ---------
    // PROTECTED
    ...
    **/
        ...
        )
    {
        ...
        String[] strsSizeKeyPublSource = UtilKstAbs.s_getStrsSizeKeyPubl(super._frmOwner_, super._strTitleAppli_, kstOpenTarget, strsAliasTarget);
        ...
        String[] strsAlgoKeyPublSource = UtilKstAbs.s_getStrsAlgoKeyPubl(super._frmOwner_, super._strTitleAppli_, kstOpenTarget, strsAliasTarget);
