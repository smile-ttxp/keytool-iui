...
public class BasicStream implements PhysicalOggStream {
   ...
   private HashMap<Integer, LogicalOggStream> _hmpLogicalStreams=new HashMap<Integer, LogicalOggStream>();
   ...
   public BasicStream(InputStream sourceStream) throws OggFormatException, IOException {
      ...
      this._hmpLogicalStreams.put(new Integer(firstPage.getStreamSerialNumber()), los);
