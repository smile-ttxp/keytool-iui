 ...
 */
 ...
 /*
   modif, bob, oct 21, 2005, updating changes in collection, from J2SDK 1.4.2 to J2SDK 1.5.0
 */
...
public class CommentHeader {
   ...
   {
      ArrayList<String> al = this._hmpComments.get(key);
      
      if(al==null) 
      {
         al = new ArrayList<String>();
         this._hmpComments.put(key, al);
      }
   ...
   public String getComment(String key) {
      ArrayList<String> al=(ArrayList<String>) this._hmpComments.get(key);
